...
def layout(**_):
    return html.Div([
        ...
        html.Div("Bug triage, P1 tracking, and resolution planning.", style={
        ...
        html.Div([
            html.Div([
                html.Div(style={
                    ...
                    "background": "var(--red)", "marginRight": "8px",
                }),
