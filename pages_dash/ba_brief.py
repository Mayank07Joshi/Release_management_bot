"""Reference — BA Team Brief"""
import dash
from dash import html

dash.register_page(__name__, path="/ba-brief", name="BA Team Brief")
...
def layout(**_):
    return html.Div([
        ...
        html.Div("Business analysis reference, team contacts, and process documentation.", style={
        ...
        html.Div([
            html.Div([
                html.Div(style={
                    ...
                    "background": "var(--text-muted)", "marginRight": "8px",
                }),
